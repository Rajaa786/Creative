    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('co_applicant_allowed', models.BooleanField(choices=[(None, 'Select Yes Or No'), (True, 'Yes'), (False, 'No')])),
                ...
                ('foir_info', models.ManyToManyField(to='master.foir_info')),
                ('multiplier_info', models.ManyToManyField(to='master.multiplier_info')),
                ('product_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='master.product')),
                ('rate_of_interest', models.ManyToManyField(to='master.rateofinterest_info')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banks', models.ManyToManyField(to='master.bankname')),
            ],
        ),
        migrations.CreateModel(
            name='Comissionrates',
